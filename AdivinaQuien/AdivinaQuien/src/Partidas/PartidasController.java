...
public class PartidasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //a estas mamadas le mueves para agregar o quitarle cosas
        //le puedes de q quitar y poner columnas
        //naco
        String[] titulos = { "Usuario 1", "Usuario 2", "Fecha", "Tiempo", "Ganador", "personajeGanador" };
        ...
        ObservableList<ObservableList<String>> datos = ConexionDB.getHistorialPartidas();
